...
namespace DTUAV.Message
{
    ...
    {
        public bool IsClose;//close the computer
    }
    [Serializable]
    public class UavCommand
    {
        /*
         * 1:IsOffboard
         * 2:IsArm
         ...
         */
        public int ComMode;
        public bool IsOffboard;//if enter in offboard mode
        public bool IsArm;//if arm
        public bool IsStart;//if start control by VR
    }

    [Serializable]
    public class UavControl
    {
        public int Mode;//0:position,1:velocity
        public double ComLX;
        public double ComLY;
        public double ComLZ;
        public double ComAX;
    ...
    public class UavInfo
    {
        ...
        //The Safe Checking
        public bool NetPx4;//the connective of the computer and PX4
        //The Status of UAV
        public bool IsArm;
        /*
         * 0: the manual mode
         ...
         * 5: the return mode
         */
        public int FMode;//the flight mode of UAV: 
        public float Voltage;//the current voltage of UAV
        public float Remaining;//the remaining of battery 
    }
