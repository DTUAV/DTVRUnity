...
{	
	...
	public class LCM
    {
        ...
        internal void Subscribe(string lcmMessageSubName, ConnectorLcm connectorLcm)
        {
        ...
        internal void Subscribe(string lcmMessageSubName, Action<LCM, string, LCMDataInputStream> messageReceived)
        {
            throw new NotImplementedException();
        }
